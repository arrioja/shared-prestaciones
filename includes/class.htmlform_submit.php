...
/**
 *  This class handles HTML submit input controls
 *
...
class HTMLForm_submit extends HTMLForm_control
{
    ...
    /**
     *  Places a submit button control
     *
     ...
     *
     *  @param  string  $caption        (optional) Caption of the submit button control
     *
