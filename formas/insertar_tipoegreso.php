<html>
<head>
<title>Módulo insertar Tipos de Egresos</title>
</head>
<body>
<?
    // Pinto la tabla del titulo
    echo "<table align=center border=2 bgcolor='#D5E7FB' width=100%>";
    echo "<tr bgcolor='#A4B4C1'><td colspan=5 align=center><strong><font size=5>Módulo: Tipos de Egresos</font></strong></td><tr bgcolor='#D5E7FB'>";
  ...
  // submitted value with another value
   function valueCompare($controlValue, $valueToCompareTo)
    ...
    $obj->setRule(array("mandatory"=>array("e1", "Por favor! Introduzca la descripción correspondiente al egreso")));
...
// creamos los parámetros de la URL: numero_pagina y total_resultados
 ...
 echo "<tr bgcolor='$color0'><th>Descripción del Egreso</th><th>Tipo del Egreso</th><th>Modificar</th><th>Eliminar</th></tr>";
 do 
  {
  //Creamos el java
