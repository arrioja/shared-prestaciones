<html>
<head>
<title>Módulo Adelanto de Prestaciones</title>
</head>
<body>
<?
    // Pinto la tabla del titulo
    echo "<table align=center border=2 bgcolor='#D5E7FB' width=100%>";
    echo "<tr bgcolor='#A4B4C1'><td colspan=5 align=center><strong><font size=5>Módulo: Adelanto de Prestaciones</font></strong></td><tr bgcolor='#D5E7FB'>";
    ...
    $form->datePickerPath = "../../datepicker/class.datepicker.php";
        ...
        $form->add("label", "label_cedula", "cedula", "Nro. Cédula Identidad");
        $obj = & $form->add("text","cedula");
        $obj->setAttributes(array("size" =>10));      
        
        $form->add("label", "label_nombre", "nombre", "Nombre Corto");
        $obj = & $form->add("text","nombre");               
        $obj->setAttributes(array("size" =>50));      

  
        
        $form->add("label", "label_fechaadelanto", "fechaadelanto", "Fecha Último Adelanto");
        $obj = & $form->add("text","fechaadelanto"); 
        $obj->setAttributes(array("size" =>10));      
        
        $form->add("label", "label_saldoprestacion", "saldoprestacion", "Saldo de Prestación");
        $obj = & $form->add("text","saldoprestacion"); 
        $obj->setAttributes(array("size" =>15));      

        $form->add("label", "label_montomaxadelanto", "montomaxadelanto", "Monto Máximo de Adelanto");
        $obj = & $form->add("text","montomaxadelanto");   
        $obj->setAttributes(array("size" =>15));      
        ...
        $obj->setRule(array("mandatory"=>array("e1", "Por favor! Corrija, el monto del adelanto excede al permitido")));
     
        $form->add("button", "button_buscar", "Buscar"); 
        ...
        $form->render("adelantoprest.xtpl");
 ?>
...
// creamos los parámetros de la URL: numero_pagina y total_resultados
 ...
 echo "<tr bgcolor='$color0'><th>Fecha del Egreso</th><th></th><th>Modificar</th><th>Eliminar</th></tr>";
 do 
  {
  //Creamos el java
