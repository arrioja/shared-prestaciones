<html>
<head>
<title>Módulo Inserta Mes en proceso</title>
</head>
<body>
<?
    // Pinto la tabla del titulo
    echo "<table align=center border=2 bgcolor='#D5E7FB' width=100%>";
    echo "<tr bgcolor='#A4B4C1'><td colspan=5 align=center><strong><font size=5>Módulo: Mes de Proceso</font></strong></td><tr bgcolor='#D5E7FB'>";
  ...
  // submitted value with another value
   ...
   $form->add("label", "label_situacion", "situacion", "Situación");
...
// creamos los parámetros de la URL: numero_pagina y total_resultados
 ...
 echo "<tr bgcolor='$color0'><th>Ano</th><th>Mes</th><th>Situación</th><th>Modificar</th><th>Eliminar</th></tr>";
 do 
  {
  //Creamos el java
